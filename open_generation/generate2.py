...
def args_parse():
    ...
    parser.add_argument("--prompt_lookup_num_tokens", default=5, type=int)
    ...
    try:
        for start in tqdm(range(0, total_prompts, args.batch_size),
            ...
            try:
                ...
                common_gen_kwargs.update(decoding_configs[args.decoding_method])
                outputs = model.generate(**common_gen_kwargs)
